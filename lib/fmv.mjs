// ═══════════════════════════════════════════════════════════════════════════
// FMV v3.5 (07.09.2026) — nur Manager-Verkaeufe zaehlen (Prinzip 0).
...
//
// Prinzipien:
// 0. NUR MANAGER-VERKAEUFE (v3.5, 07.09.2026, Vorgabe Jonas, bindend).
...
export function calculateFMV(sales, floorPrice, now = Date.now(), opts = {}) {
  ...
  const inWindow = (list, maxAgeDays) => list
